        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FlippedCardsTotal = table.Column<long>(type: "bigint", nullable: false),
                    FlippedCardsToday = table.Column<int>(type: "int", nullable: false),
                    LearningStreak = table.Column<int>(type: "int", nullable: false),
                    TotalDecks = table.Column<int>(type: "int", nullable: false),
                    TotalCards = table.Column<long>(type: "bigint", nullable: false),
                    TotalMasteredCards = table.Column<long>(type: "bigint", nullable: false),
                    LastFlipAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    WeeklyActivityJson = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DeckId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    KnowledgePercentage = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RotationPoints = table.Column<int>(type: "int", nullable: false),
                    RotationIndex = table.Column<int>(type: "int", nullable: false),
                    IsMastered = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
